...
const CemberinCevresi= (yarıçap) => 2 * pi * yarıçap;
...
const sayi = sayilar.length;

console.log("dizideki sayilar",sayi);
	...
	console.log("3a max değer " ,enbuyuk);
	console.log("3a min değer " ,enkucuk);
